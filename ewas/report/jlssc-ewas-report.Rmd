---
title: Using the joint location-and-scale score test to jointly test the mean and variance DNAm differences between atopic dermatitis cases and controls
...
Note: In the default settings of the `jlssc()` function, covariates are not taken into account when estimating differences in variance.
